...
%prep
%setup -q -n azure-mgmt-resource-21.0.0
cd %{_builddir}/azure-mgmt-resource-21.0.0
...
cp %{_builddir}/azure-mgmt-resource-21.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_resource/7aea571d641549de89730da8e7ff5a6940c5526b
