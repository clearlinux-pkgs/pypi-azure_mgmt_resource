...
Version  : 21.2.0
Release  : 12
URL      : https://files.pythonhosted.org/packages/2e/7a/5980b32aa537373ff0b737c1576011532ec5623d7730bde76ce29816dcbe/azure-mgmt-resource-21.2.0.zip
Source0  : https://files.pythonhosted.org/packages/2e/7a/5980b32aa537373ff0b737c1576011532ec5623d7730bde76ce29816dcbe/azure-mgmt-resource-21.2.0.zip
...
%prep
%setup -q -n azure-mgmt-resource-21.2.0
cd %{_builddir}/azure-mgmt-resource-21.2.0
pushd ..
cp -a azure-mgmt-resource-21.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665496295
