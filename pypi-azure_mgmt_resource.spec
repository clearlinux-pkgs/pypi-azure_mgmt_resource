...
%prep
%setup -q -n azure-mgmt-resource-21.1.0
cd %{_builddir}/azure-mgmt-resource-21.1.0
pushd ..
cp -a azure-mgmt-resource-21.1.0 buildavx2
popd
...
cp %{_builddir}/azure-mgmt-resource-21.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_resource/7aea571d641549de89730da8e7ff5a6940c5526b
