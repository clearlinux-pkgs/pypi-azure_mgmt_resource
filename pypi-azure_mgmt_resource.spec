...
Source0  : https://files.pythonhosted.org/packages/71/e9/cafb7076283db9f21e05e54fa0536b16d790e43f30691e80d6eac4603789/azure_mgmt_resource-23.2.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_resource-23.2.0
cd %{_builddir}/azure_mgmt_resource-23.2.0
pushd ..
cp -a azure_mgmt_resource-23.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729781992
