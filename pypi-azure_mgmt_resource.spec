...
Source0  : https://files.pythonhosted.org/packages/a7/28/e950da2d89e55e2315ff0f4de075da4ac0fed4c27a489f7c774dedde9854/azure_mgmt_resource-23.3.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_resource-23.3.0
cd %{_builddir}/azure_mgmt_resource-23.3.0
pushd ..
cp -a azure_mgmt_resource-23.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740588655
