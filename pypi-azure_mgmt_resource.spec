...
Source0  : https://files.pythonhosted.org/packages/5e/2e/731c99e3d5d0caba951ea59d3ee9bfb3606eea9f9e59fddc1fe8c1d11dd5/azure_mgmt_resource-23.4.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_resource-23.4.0
cd %{_builddir}/azure_mgmt_resource-23.4.0
pushd ..
cp -a azure_mgmt_resource-23.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747835990
