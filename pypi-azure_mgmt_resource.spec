...
Source0  : https://files.pythonhosted.org/packages/50/4c/b27a3dfbedebbcc8e346a956a803528bd94a19fdf14b1de4bd781b03a6cc/azure_mgmt_resource-24.0.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_resource-24.0.0
cd %{_builddir}/azure_mgmt_resource-24.0.0
pushd ..
cp -a azure_mgmt_resource-24.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750168262
...
cp %{_builddir}/azure_mgmt_resource-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_resource/7aea571d641549de89730da8e7ff5a6940c5526b || :
